...
climate_ir_lg_x_ns = cg.esphome_ns.namespace("climate_ir_lg_x")
LgIrClimateX = climate_ir_lg_x_ns.class_("LgIrClimateX", climate_ir.ClimateIR)
...
CONFIG_SCHEMA = climate_ir.climate_ir_with_receiver_schema(LgIrClimateX).extend(
    {
        cv.Optional(
